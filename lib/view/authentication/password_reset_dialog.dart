...
Future<void> passwordResetDialog(
    BuildContext context, String mobileNumber, String? otp,
    {type: String}) async {
  return showDialog(
    context: context,
    builder: (context) {
      void confirmPassword() {
        ...
        final Future<OTPConfirm> successfulMessage = auth.updatePassword(
            mobileNumber, _textFieldController.text, _otpFieldController.text);
        ...
        content: Column(
          ...
          children: [
            TextField(
              ...
              decoration:
                  commonInputDecoration("New Password", "Type new password"),
            ),
            SizedBox(
              height: 15,
            ),
          ...
          TextButton(
            ...
            onPressed: () {
              if (_textFieldController.text.isNotEmpty &&
                  _otpFieldController.text.isNotEmpty) {
