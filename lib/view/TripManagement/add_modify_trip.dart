...
class AddUpdateTrip extends StatefulWidget {
  ...
  @override
  _AddUpdateTripState createState() => _AddUpdateTripState();
}
            ...
            if (_selectedDropItem.vehicleId != "" &&
                ...
                endPointLong.text != "")
              {
                ...
                accidentAddUpdate = TripListProvider().addUpdateTrip(
                    ...
                    endPoint.text,
                    dateTime),
                accidentAddUpdate?.whenComplete(() => {Navigator.pop(context)})
              }
            else
              ...
              children: [
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Container(
                      ...
                      child: EditListItem(
                          text: 'Start Point',
                          nameController: startPoint,
                          isEditAble: false,
                          hintText: 'Click in map')),
                  IconButton(
