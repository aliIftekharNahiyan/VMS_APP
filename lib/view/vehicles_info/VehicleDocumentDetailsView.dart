...
class VehicleDocumentDetailsView extends StatefulWidget {
  ...
  VehicleDocumentDetailsView({ required this.vehicleId, required this.requestType, required this.vcDataModel}) ;

  @override
  _VehicleDocumentDetailsViewState createState() => _VehicleDocumentDetailsViewState();
}

class _VehicleDocumentDetailsViewState extends State<VehicleDocumentDetailsView> {
                                  ...
                                  child:InkWell(
                                    ...
                                    child: Column(children: <Widget>[
                                      VehicleListItem(
                                          ...
                                          text: vehicleInfoDataModel.documentName ?? ""),
                                      VehicleListItem(
                                          textTitle: 'Expire Date:',
                                          text: convertDate2(vehicleInfoDataModel.expiryDate ?? "")),
                                      VehicleListItem(
                                          textTitle: 'Amount:',
                                          text: vehicleInfoDataModel.coverageDetails ?? "")
                                    ]),
                                  )
                              ),
