...
class DropDown extends StatefulWidget {
  ...
  DropDown(this.list, {this.isExpanded = false, this.isUnderline = true, this.requestType, this.selectedItem});
...
class _DropDownState extends State<DropDown> {
 ...
 // String? _selecteditem;
  ...
  String? requestType;
  String? selectedItem;
  _DropDownState(this._list, this.expanded, this.underline, this.requestType, this.selectedItem);
      ...
      onChanged: (newValue) {
        setState(() {
          ...
          if (requestType == "vehicleList"){
            ...
            _selectedDropItem.vehicleBrandFullName = _list.where((oldValue) => newValue.toString() == (oldValue.id.toString())).first.name.toString();
         ...
         //   print("AllSelectedType  ${ _selectedDropItem.vehicleTypeId}  brand ${ _selectedDropItem.vehicleBrandName}  model ${_selectedDropItem.vehicleModelName}");
            ...
            _selectedDropItem.vehicleModelFullName = _list.where((oldValue) => newValue.toString() == (oldValue.id.toString())).first.name.toString();
            _selectedDropItem.vehicleModelId = newValue;

          }else if (requestType == "VehicleColour"){
            _selectedDropItem.vehicleColourId = newValue;
            _selectedDropItem.vehicleColourFullName = _list.where((oldValue) => newValue.toString() == (oldValue.id.toString())).first.name.toString();
            ...
            Provider.of<ServiceProvider>(context, listen: false)
                .getMonthlyReport(AppConstant.startDate, AppConstant.endDate, _selectedDropItem.vehicleId, _selectedDropItem.serviceType,
                "${AppConstant.userId}");
            ...
            _selectedDropItem.serviceNameListName = _list.where((oldValue) => newValue.toString() == (oldValue.id.toString())).first.name.toString();
            print("serviceNameListName   ${_selectedDropItem.serviceNameListName}");
          }
